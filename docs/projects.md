...
A full list of projects and publications is available on [Google Scholar](https://scholar.google.com.ar/citations?hl=en&user=PNNFrAQAAAAJ&view_op=list_works&sortby=pubdate){:target="_blank"}.
...
- Year / Venue: 2013 · IEEE
- [Full text](https://ieeexplore.ieee.org/document/6746822){:target="_blank"} — IEEE Xplore
- [Source code](https://github.com/javierip/flash-video-summarization){:target="_blank"} — GitHub
...
- [Buy on Amazon](https://www.amazon.com/Making-Computing-Efficient-Hardware-Architectures/dp/3639178513/ref=sr_1_1?ie=UTF8&s=books&qid=1279828856&sr=8-1){:target="_blank"}
